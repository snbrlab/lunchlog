    ...
    <div ref={containerRef} className="relative">
      ...
      {open && (
        <div
          role="dialog"
          aria-label="알림 목록"
          className="absolute right-0 top-full z-50 mt-2 w-[min(360px,90vw)] max-h-[70vh] overflow-hidden rounded-lg border border-border bg-bg shadow-xl ring-1 ring-black/5"
        >
