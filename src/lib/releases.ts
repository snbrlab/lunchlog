...
export const RELEASES: ReleaseItem[] = [
  {
    ...
    bullets: [
      '헤더 🖥️ → /dev. 사옥/점심|저녁/cuisine/식당 트리를 Unix 처럼 탐색',
      '📂 ls -al / cd / cat / pwd / tree — README.md, INFO, MENU, .kakao 열람',
      '📜 git log / show / contributors / stats / branch / checkout',
      '🔍 grep [-i] / find — commit 메시지 + 파일 + 식당 이름 검색',
      '🍱 finger / myself / random / near / trending / leaderboard',
      '🛠 wc / head / tail / echo / uname / uptime / env',
      '🎨 cowsay 🐮 / fortune 🥠 / lolcat 🌈 / theme matrix·amber·classic',
      '😜 Easter eggs: sudo, rm -rf, vim, apt 등',
    ],
  },
  {
    version: 'D78',
