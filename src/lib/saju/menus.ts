...
export const MENU_POOL: Record<Element, Record<Strength, string[]>> = {
  ...
  土: {
    weak: ['제육덮밥', '사골만두국', '장조림버터비빔밥', '간장계란밥', '돼지국밥'],
  ...
  金: {
    ...
    strong: ['스시 오마카세', '카이세키', '궁중 신선로', '랍스터 테일 구이', '토마호크 스테이크'],
  },
  水: {
    weak: ['잔치국수', '양지 쌀국수', '오징어 순대', '콩나물국밥', '해초 물회'],
    mid: ['바지락 칼국수', '새우 완탕면', '간장게장', '밀푀유나베', '보리굴비정식'],
    strong: ['대방어', '해물 누룽지탕', '참치회 특선', '독도새우', '킹크랩'],
  },
};
